TARGETS = console-setup mountkernfs.sh resolvconf hostname.sh apparmor screen-cleanup plymouth-log udev keyboard-setup cryptdisks cryptdisks-early networking urandom iscsid checkroot.sh lvm2 checkfs.sh hwclock.sh open-iscsi mountdevsubfs.sh mountall.sh mountnfs-bootclean.sh mountnfs.sh bootmisc.sh checkroot-bootclean.sh kmod procps mountall-bootclean.sh
